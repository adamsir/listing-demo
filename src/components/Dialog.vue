    ...
    <div class="modal-container bg-white w-11/12 mx-auto rounded shadow-lg z-50 overflow-y-auto">
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <div class="flex justify-between items-center pb-3">
          ...
          <div @click="setVisible(false)" class="modal-close cursor-pointer z-50">
        ...
        <div class="flex justify-end pt-2">
          <button @click="setVisible(false)" class="modal-close px-4 bg-indigo-500 p-3 rounded-lg text-white hover:bg-indigo-400">Close</button>
        </div>
